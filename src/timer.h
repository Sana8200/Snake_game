 ...
 * @param target_frequency_hz The desired number of ticks per second.
 */
void timer_init(int target_frequency_hz);

/**
 * @brief Checks if the timer has ticked since the last check.
 * This is for polling. It also clears the tick flag.
 * @return true if the timer has ticked, false otherwise.
 */
